...
class Config:
    ...
    SQLALCHEMY_ENGINE_OPTIONS = {
        ...
        "pool_size": 10,             # Tamaño óptimo del pool de conexiones para Neon DB
        "max_overflow": 5,           # Permitir 5 conexiones adicionales si el pool está lleno
        ...
        "connect_args": {
            ...
            "sslmode": "require",    # Exigir SSL para conexión segura
        },
